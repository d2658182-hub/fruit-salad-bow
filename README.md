...
**Desktop**
- **Mouse drag + release** to aim and shoot — hold left click, pull back to set angle and power, release to fire
- **Mouse click** on all menu buttons (Play, Restart, Continue)

**Mobile / Tablet**
- **Swipe + release** to aim and shoot — drag your finger back, lift to fire
- **Tap** to navigate menus

No keyboard needed. Works flawlessly in portrait and landscape.
